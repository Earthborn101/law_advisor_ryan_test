defmodule LawAdvisorRyanTestWeb.CoreComponents.Alert do
  @moduledoc """
  Renders a breadcrumbs.

  ## Examples
    <.alert color="info">This is an info state</.alert>
  ...
  attr :color, :string, values: ["info", "success", "warning", "danger"]
  attr :class, :string
  attr :label, :string
  slot :inner_block
