defmodule LawAdvisorTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LawAdvisorTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LawAdvisorTestWeb.Gettext, "errors", msg, opts)
    end
  end
